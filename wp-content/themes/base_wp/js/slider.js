...
(function($)
{
	$.fn.slider = function(d, m)
	{
		return this.each(function()
		{
			var o = $(this),
				methods = {
					...
					appendControls: function()
					{
						// Create timer
						if(o.settings.showTimer)
							o.timer = $('<div />').addClass('timer').css({position:'absolute', width:'100%', height:'8px', bottom:0, backgroundColor:'#fff', opacity:0.2, zIndex:1000}).insertAfter(o.parent());
					...
					startTimer: function()
					{
						o.timer.css({width:'0%'}).animate({width:'100%'}, o.delay);
					},
			...
			o.methods = $.extend(methods, $.fn.slider.methods, m);
			o.settings = $.extend({}, defaults, $.fn.slider.defaults, d);
