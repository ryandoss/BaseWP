...
class GFPayPalPro {
    ...
    public static function paypalpro_after_submission($entry, $form){
        ...
        if($payment_method == "paypalpro"){
            ...
            self::confirm_payment($entry, $form, rgar(self::$transaction_response,"subscription_id"), self::$transaction_response["transaction_id"], $is_recurring , rgar(self::$transaction_response,"initial_payment_amount"), rgar(self::$transaction_response,"subscription_amount"), false);
        }
    }

    public static function confirm_payment($entry, $form, $subscriber_id, $transaction_id, $is_recurring, $initial_payment_amount, $subscription_amount, $is_pending){
