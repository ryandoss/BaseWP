 ...
 *
 * SEVENSPARK NOTE:
 * Each instance of lessc() in this file has been renamed uber_lessc() to avoid conflicts with other plugins
 * and ensure that the proper version is loaded
 * 
 */
class uber_lessc {
	protected $buffer;
